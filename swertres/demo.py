...
def export_results(time, gap, results, seq_types):
    ...
    with open("results_seq_types_v2.2.txt", "a") as fo:
...
#             print("seq_types:")
#             for seq in seq_types["diff_one"]:
#                 print("{} <- {}".format(seq, get_pos_digits(seq, "diff_one")))
#                 d_one_digits.append(get_pos_digits(seq, "diff_one"))
...
#             if seq_types["common"][0] not in common_digits:
#                 common_digits.extend(seq_types["common"])
