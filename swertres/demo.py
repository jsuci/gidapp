...
#                 d_one_digits.extend(get_pos_digits(seq, "diff_one"))
...
# generated_date = "11 mon mar 2019".split(" ")

# current_date = datetime.now().replace(day=int(generated_date[0])) + timedelta(days=3)
