...
def date_gap():
    ...
    INPUT:
        ...
        results_count_missing_v1.3.txt
    ...
    with open("results_diff_one_v1.3.txt", "r") as f1, \
...
def find_diff_one():
    ...
    with open("results_diff_one_v1.3.txt", "a") as fo, \
            open("my_probables_v1.3.txt", "a") as fp:
    ...
    if result_gap:
        with fileinput.input("results_diff_one_v1.3.txt", inplace=True) as fio:
            for entry in fio:
                if "updated:" in entry:
